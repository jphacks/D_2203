			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/logo.png" alt="Vulnlab Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="images/logo@2x.png" alt="Vulnlab Logo"></a>
						</div>
						<!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link" href="indexx.html"><div>Home</div></a>
								</li>
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>Menu</div></a>
								...
								<li class="menu-item mega-menu">
									<a class="menu-link" href="#"><div>reference</div></a>
									<div class="mega-menu-content mega-menu-style-2">
										<div class="container">
											<div class="row">
												<ul class="sub-menu-container mega-menu-column col-lg-3">
									...
									<div class="widget clearfix">
										...
										<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
											<address>
												...
												Ritsumeikan University<br>Biwako-Kusatsu Campus (BKC)<br>
												1-1-1 Noji-higashi, Kusatsu<br>
												Shiga 5258577 JAPAN
											</address>
							...
							<div class="row col-mb-50">
									...
									<div class="widget clearfix" style="margin-bottom: -20px;">
										...
										<div class="row">
											...
											<div class="col-lg-6 bottommargin-sm">
												<div class="counter counter-small"><span data-from="50" data-to="99999" data-refresh-interval="80" data-speed="3000" data-comma="true"></span></div>
												<h5 class="mb-0">Total Users</h5>
											</div>

											<div class="col-lg-6 bottommargin-sm">
												<div class="counter counter-small"><span data-from="100" data-to="99999" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
								...
								<div class="col-md-5 col-lg-12">
									<div class="widget subscribe-widget clearfix">
										<h5>If you would like to support this project,<br>please send us your Email address.</h5>
										<br>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-start">
							Copyrights &copy; 2022 All Rights Reserved by RiST<br>
						...
						<div class="col-md-6 text-center text-md-end">
							<div class="d-flex justify-content-center justify-content-md-end">
								...
								<a href="https://twitter.com/realRiST" class="social-icon si-small si-borderless si-twitter">
								...
								<a href="https://github.com/jphacks/D_2203" class="social-icon si-small si-borderless si-github">
							...
							<i class="icon-envelope2"></i> ~~~@~~~.~~~ <span class="middot">&middot;</span> <i class="icon-headphones"></i> ~~~~~~~~ <span class="middot">&middot;</span> 
							<!-- <i class="icon-skype2"></i> RiSTOnSkype -->
						</div>
